...
export const ClassCard: React.FC<ClassCardProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-all duration-200 animate-fade-in">
        ...
        <div className="flex-shrink-0 ml-4">
          {isSignedUp ? (
            ...
            <button
              ...
              disabled={isLoading || parseInt(gymClass.availabilityNumber) === 0}
              className={`px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 flex items-center gap-2 ${
                parseInt(gymClass.availabilityNumber) === 0
            ...
            >
              {isLoading ? (
                ...
                <span>
                  {parseInt(gymClass.availabilityNumber) === 0 ? 'Full' : 'Sign Up'}
                </span>
              )}
            </button>
          )}
